...
def crear_pedido():
    try:
        ...
        # Validar que no exista un pedido con el mismo numero_pedido
        if pedidos_collection.find_one({'numero_pedido': numero_pedido}):
            return jsonify({'error': 'El pedido ya existe'}), 409
