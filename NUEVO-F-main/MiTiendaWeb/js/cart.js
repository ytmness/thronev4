...
function actualizarCarrito() {
  ...
  carrito.forEach((producto, index) => {
    ...
    } else if (producto.img && producto.img.trim() !== "") {
        rutaImagen = `http://127.0.0.1:3000/static/img/productos/${producto.img}`;
    } else if (producto.imagen && producto.imagen.startsWith("http")) {
        rutaImagen = producto.imagen;
    } else if (producto.imagen && producto.imagen.trim() !== "") {
        rutaImagen = `http://127.0.0.1:3000/static/img/productos/${producto.imagen}`;
    } else {
